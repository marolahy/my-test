<?php
namespace MindGeekTest\Utils;

use ArrayObject;
use PHPUnit\Framework\TestCase;
use stdClass;
use MindGeek\Utils\ArrayUtils;
use MindGeek\Utils\ArrayUtils\MergeRemoveKey;
use MindGeek\Utils\Exception\InvalidArgumentException;
...
class ArrayUtilsTest extends TestCase
{
    ...
    public function testMergeReplaceKey()
    {
        ...
        $b = [
            'car' => new \MindGeek\Utils\ArrayUtils\MergeReplaceKey([
                'met' => 'bet',
            ]),
            'new' => new \MindGeek\Utils\ArrayUtils\MergeReplaceKey([
                'foo' => 'get',
            ]),
        ];
        $this->assertInstanceOf('MindGeek\Utils\ArrayUtils\MergeReplaceKeyInterface', $b['car']);
