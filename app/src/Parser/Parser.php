 ...
 */
class Parser implements Countable, Iterator, ArrayAccess
{

    /**
     * Data within the Parseruration.
     *
     * @var array
     */
    protected $data = [];
    ...
    /**
     * Deep clone of this instance to ensure that nested MindGeek\Parsers are also
     * cloned.
     *
     * @return void
     */
    ...
    /**
     * Merge another Parser with this one.
     *
     * For duplicate keys, the following will be performed:
     * - Nested Parsers will be recursively merged.
     ...
     * @return self
     */
    public function merge(Parser $merge)
    {
        /** @var Parser $value */
